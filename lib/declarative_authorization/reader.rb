...
module Authorization
  ...
  # * AuthorizationRulesReader#contains_only,
  ...
  module Reader
    ...
    class AuthorizationRulesReader
      ...
      # Only available with PostgreSQL and the extension `intarray`.
      # Stricter than contains, it does check if the collection specified
      # by the if_attribute attribute is **exactly** a subset of the specified value.
      def contains_only (&block)
        [:contains_only, block]
      end
